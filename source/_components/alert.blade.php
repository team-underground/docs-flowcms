...
@php
$alertClass = [
    'info' => 'text-lg bg-indigo-100 text-indigo-700 border-t-8 border-indigo-300',
...
<div>
    <div class="w-full my-4 relative flex px-6 py-4 rounded-lg {{ $alertClass[$variant] }}" role="alert">
        <div class="flex-shrink-0 mr-5 pt-px">
            @if($variant == 'info')   
                <svg class="w-8 h-8 text-indigo-600" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
            @endif
            @if($variant == 'success')   
